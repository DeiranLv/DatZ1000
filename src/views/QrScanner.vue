...
<template>
  <DemoView kind="m" :show-value="false" label="LxQR" :git-link="baseGitUrl + 'QrScanner.vue'">
    <LxQrScanner
      @update="modelUpdate"
      :hasFileUploader="fileUploader"
      :formats="formats"
      :kind="kind"
      :texts="texts"
      :hasFlashlightToggle="flashlight"
      :showAlerts="showAlerts"
      :cameraSwitcherMode="mode"
    />
    <template #menu>
      <LxExpander v-model="mainExpanded" label="Main props" icon="config">
        <div class="lx-form">
          <div class="lx-row">
            <label>:hasFileUploader</label>
          ...
          <div class="lx-row">
            <label>:hasFlashlightToggle</label>
          ...
          <div class="lx-row">
            <label>:cameraSwitcherMode</label>
